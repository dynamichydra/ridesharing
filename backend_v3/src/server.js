...
import { pricingVersionRoutes } from './modules/pricing-version/pricing-version.routes.js';
...
async function build() {
  ...
  await app.register(pricingVersionRoutes, { prefix: `${PREFIX}/pricing-versions` });
