      ...
      if (topic === TOPICS.RIDE_MATCHED) {
        ...
        for (const c of (payload.candidates || [])) {
          ...
          _io.of('/driver').to(`driver:${c.driverId}`).emit('ride:new_request', {
            ...
            grossEstimatedFare: payload.grossEstimatedFare || payload.estimatedFare,
            riderEstimatedFare: payload.riderEstimatedFare || payload.estimatedFare,
            promoIncentive: payload.promoIncentive || 0,
