...
export const paymentIntents = pgTable('payment_intents', {
  ...
  payerType:         varchar('payer_type', { length: 30 }).default('rider').notNull(), // rider | driver
  ...
  referenceType:     varchar('reference_type', { length: 50 }).notNull(), // ride | subscription | rider_subscription | wallet_topup
  referenceId:       uuid('reference_id'),
  paymentMethodType: varchar('payment_method_type', { length: 30 }), // card | upi | wallet | split | cash
