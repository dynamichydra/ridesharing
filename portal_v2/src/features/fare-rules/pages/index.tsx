...
import { DollarSign, Percent, Split, Plane, Moon, Zap, Calculator, Layers } from "lucide-react";
import { cn } from "@/lib/utils";
import PricingPlansTab from "./pricing-plans";
...
const TABS = [
  { key: "pricing-plans", label: "Pricing Plans & Versions", icon: Layers },
  { key: "fare-rules", label: "Legacy Multiplier Rules", icon: DollarSign },
...
export default function FareRulesPage() {
  const [activeTab, setActiveTab] = useState<TabKey>("pricing-plans");
  ...
  return (
    <div className="w-full flex-col flex gap-4">
      ...
      {activeTab === "pricing-plans" && <PricingPlansTab />}
