    ...
    <div className="space-y-6">
      ...
      {quoteResult && (() => {
        ...
        const bookingFeeMinor =
          ...
          quoteResult.breakdown?.fees?.bookingFeeMinor ??
          0;
        const platformFeeMinor =
          quoteResult.platformFeeMinor ??
          quoteResult.breakdown?.fees?.serviceFeeMinor ??
          0;
        const totalPlatformFeeMinor = bookingFeeMinor + platformFeeMinor;

        // Driver Earnings (Protected from promo discounts)
        const driverEarningsMinor = Math.max(0, grossFareMinor - totalPlatformFeeMinor);
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-center">
              ...
              <div className="p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/20 space-y-1">
                ...
                <span className="text-[11px] text-muted-foreground block">
                  100% full gross base (Unpenalized)
                </span>
              </div>
                    ...
                    <div className="px-4 py-2.5 flex items-center justify-between bg-sky-500/5">
                      <div>
                        ...
                        <span className="text-[11px] text-muted-foreground">
                          Booking Fee: {formatMoney(bookingFeeMinor)} | Service Fee: {formatMoney(platformFeeMinor)}
                        </span>
                      </div>
