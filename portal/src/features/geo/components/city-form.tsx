  ...
  return (
    <div className="space-y-4 py-2 text-foreground">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="ct-cityTypeId">Economic Tier / City Type</Label>
          <NativeSelect id="ct-cityTypeId" {...register("cityTypeId")}>
            <NativeSelectOption value="">None (Standard Base)</NativeSelectOption>
            {cityTypes.map((t) => (
      ...
      <div className="space-y-3 pt-2 border-t border-border/60">
        ...
        {boundaryTab === "map" && (
          <ServiceAreaMapDrawer
            ...
            hint="Draw the full operating perimeter polygon of this city on Google Maps. All rides and zone features will operate inside this boundary."
          />
        )}
