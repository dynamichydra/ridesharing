  ...
  return (
    <>
      ...
      <Card className="border-border bg-card shadow-sm md:col-span-2">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-base">
            <Wallet className="h-4 w-4 text-primary" /> Payment Attempts
          </CardTitle>
          <CardDescription>
            Gateway transactions linked to this driver's subscriptions. Attempts that failed
            before ever activating a subscription aren't traceable to a driver yet.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {paymentsLoading ? (
