...
abstract class OnboardingRepository {
  ...
  Future<DriverProfile> updateProfile({required String name, required String email, String? dob, String? gender, String? referralCode});
  ...
  Future<bool> setDrivingLocation({required String countryId, required String stateId, required String cityId});
  Future<bool> acceptLegalDocument(String documentId);
  Future<List<DriverDocument>> getMyDocuments();
  Future<String> requestUploadUrl(String documentTypeId, String side, String contentType);
  Future<bool> uploadDocumentFile(String uploadUrl, List<int> bytes, String contentType);
  Future<DriverDocument> confirmDocument(String documentTypeId, {required String side, required String key, String? documentNumber, String? expiryDate});
  Future<String> requestProfilePhotoUploadUrl(String contentType);
  Future<DriverProfile> confirmProfilePhoto(String key);
  Future<List<DriverVehicle>> getMyVehicles();
  Future<DriverVehicle> addVehicle({required String vehicleTypeId, required String model, required String year, required String registrationNumber, String? color});
